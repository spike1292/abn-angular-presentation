    ...
    .factory('instagram', function ($resource) {
        ...
        return {
            fetchPopular: function (callback) {
                ...
                var api = $resource('https://api.instagram.com/v1/tags/coffee/media/recent?client_id=:client_id&callback=JSON_CALLBACK', {
...
// defined below. It will be available inside the function automatically.
    .controller('SwitchableGridController', function SwitchableGridController($scope, instagram) {
